...
/**
 * 对于每个发送的 {@link PorticoMessage}，都需要一个响应。此类是所有响应消息的父类。<br>
 * 它可以通过其 {@link #isError()} 标志来表示基本的“成功”或“错误”响应。<br>
 * 用户可以通过继承此类来设计自己的自定义响应类型（与设计自定义请求的方式相同）。<br>
 * 为方便起见，消息框架提供了几个辅助扩展类：<br>
 * 
 * <ul>
